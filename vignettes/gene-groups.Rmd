---
title: "Working with HGNC Gene Groups"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Working with HGNC Gene Groups}
...
This vignette demonstrates how to discover, explore, and work with HGNC gene groups using `hgnc.mcp`.
...
Use `hgnc_group_members()` to get all genes in a specific group:
...
- Set up the [MCP Server](running-mcp-server.html) to access groups via API
- Review the [Getting Started](getting-started.html) guide
