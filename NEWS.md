...
* `build_symbol_index()` - Create efficient in-memory lookup indexes
...
This is the first development release of hgnc.mcp. The package provides a complete
toolkit for working with HGNC gene nomenclature in R, with particular focus on:
...
The package is ready for use in research and production environments, with active
development continuing for additional features and improvements.
