...
# Resources are now registered directly via pr_mcp_resource() in R/mcp_server.R
# The following resource endpoints have been removed:
# - GET /resources/gene_card -> now registered as hgnc://gene/{hgnc_id}
# - GET /resources/group_card -> now registered as hgnc://group/{group_id_or_name}
# - GET /resources/snapshot -> now registered as hgnc://snapshot
# - GET /resources/changes_summary -> now registered as hgnc://changes/{since}
